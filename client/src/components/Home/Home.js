...
const Home = () => {
  ...
  const createClass = async () => {
    ...
    await axios.post('http://classroom-service:4235/create_class', {
      userId, title
    });
  }
  ...
  const joinClass = async () => {
    ...
    await axios.post('http://classroom-service:4235/add_class', {
      userId, classId
    });
  };

  const fetchClasses = async () => {
    const res = await axios.get('http://classroom-service:4235/get_classes/' + userId);
